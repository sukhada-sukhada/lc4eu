# PLEASE REPLACE 'sukhada' WITH YOUR SYSTEM NAME"
...
runACE_Command = ["/home/sukhada/ace-0.9.34/ace", "-g","/home/sukhada/ace-0.9.34/erg-1214-x86-64-0.9.34.dat","-1Tf",".ace_input"]
try:
    result = subprocess.run(runACE_Command, stdout=subprocess.PIPE)
    aceOut = str(result.stdout,'utf-8')
except:
    print("PLEASE REPLACE 'sukhada' WITH YOUR SYSTEM NAME\n")
...
seperator = '\n'+'*'*30+ '  End   '+ '*'*30 + '\n\n'
print('\n'+'*'*30+ ' ACE MRS Output: '+ '*'*30 )
print(aceOut.strip(),end=seperator)
print('\n'+'*'*30+ ' lc.sh Script MRS Output '+ '*'*30 )
